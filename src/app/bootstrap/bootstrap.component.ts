...
import { EditorComponent, IDefaultForm, IStylesConfig, bootstrapConfig } from '@sesan07/ngx-formly-editor';
...
@Component({
    ...
    `,
    standalone: true,
    imports: [FormlyBootstrapModule, FormlyModule, EditorComponent],
})
